...
async function test() {
  ...
  try {
    ...
    if (statsBtn) {
      ...
      console.log('Step 3: 查看收款列表统计信息');
    }

    await page.screenshot({ path: path.join(SCREENSHOT_DIR, '8.7-success.png'), fullPage: true });

    console.log('========================================');
    console.log('场景: 8.7 收款统计报表');
    console.log('状态: ✓ 通过');
    console.log('========================================');
    return true;
