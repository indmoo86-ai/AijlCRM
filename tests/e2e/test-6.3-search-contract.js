...
async function test() {
  ...
  try {
    ...
    const searchInput = await page.$('input[placeholder*="合同"]');
    if (searchInput) {
    ...
    await page.screenshot({ path: path.join(SCREENSHOT_DIR, '6.3-success.png'), fullPage: true });

    console.log('========================================');
    console.log('场景: 6.3 搜索合同');
    console.log('状态: ✓ 通过');
    console.log('========================================');
    return true;
