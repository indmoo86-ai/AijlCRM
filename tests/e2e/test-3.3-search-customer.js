...
async function test() {
  ...
  try {
    ...
    const searchInput = await page.$('input[placeholder*="客户"]');
    if (searchInput) {
    ...
    await page.screenshot({ path: path.join(SCREENSHOT_DIR, '3.3-success.png'), fullPage: true });

    console.log('========================================');
    console.log('场景: 3.3 搜索客户');
    console.log('状态: ✓ 通过');
    console.log('========================================');
    return true;
