...
async function test() {
  ...
  try {
    ...
    if (statsBtn) {
      ...
      console.log('Step 3: 查看发货列表统计信息');
    }

    await page.screenshot({ path: path.join(SCREENSHOT_DIR, '7.8-success.png'), fullPage: true });

    console.log('========================================');
    console.log('场景: 7.8 发货统计报表');
    console.log('状态: ✓ 通过');
    console.log('========================================');
    return true;
