...
async function test() {
  ...
  try {
    ...
    console.log('  发票数量:', rows.length);

    await page.screenshot({ path: path.join(SCREENSHOT_DIR, '9.3-success.png'), fullPage: true });

    console.log('========================================');
    console.log('场景: 9.3 搜索发票');
    console.log('状态: ✓ 通过');
    console.log('========================================');
    return true;
