...
with open('schema.sql', 'w', encoding='utf-8') as f:
    f.write(DDL_TEMPLATE + TABLES_SUMMARY)
    f.write("\n\n-- DDL内容详见：schema_full.sql（完整版）\n")
    f.write("-- 本文件为简化清单，用于快速了解表结构\n\n")
    f.write("SET FOREIGN_KEY_CHECKS = 1;\n")

print("✅ DDL清单文件已生成：schema.sql")
print("📝 下一步：请基于requirements.md v9.1第7章生成完整DDL")
